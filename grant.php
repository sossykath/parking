        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button class="btn btn-success" name="submit"><a href="rupdate.php?id=<?php echo $row['id'] ?>"> Assign Slot</a></button></td>
                    <td><button class="btn btn-danger"><a href="grant.php?delete=<?php echo $row['id'] ?>" onclick="return"
