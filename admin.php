...
<nav class="navbar navbar-expand-sm bg-info ">
	...
	<ul class="navbar-nav">
			<div class="nav-item">
			<form class="nav-link text-white" action="adsub.php" method="post">
			   <div class="input-group">
				<input type="text" name="admin" class="form-control" placeholder="Admin Username">
				<br>
				<input type="password" name="password" class="form-control" placeholder="Admin Password" style="display: inline-block;">
